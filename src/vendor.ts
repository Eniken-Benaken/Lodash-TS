...
// import unionBy from "./app/lodash/Array-unionBy";
// import unionWith from "./app/lodash/Array-unionWith";
// import unic from "./app/lodash/Array-unic";
// import unicBy from "./app/lodash/Array-unicBy";
import unicWith from "./app/lodash/Array-unicWith";
...
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => console.log(unionBy([array2,array,array3],toStr)));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => console.log(unionWith([array2,array,array3],Equals)));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => console.log(unic(array3)));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => console.log(unicBy(array3,toStr)));
if(secondaryButton !== null) secondaryButton.addEventListener("click", () => console.log(unicWith(array3,Equals)));
