...
const lastIndexOfBy = (array: Array<any>, value: any, iteratee:Function, startIndex?: number) => {
	/**
	...
	for (index; index>=0;index--) {
		if (Equals(iteratee(array[index]),iteratee(value))) return index;
	}
	return -1;
	} 
	/**
