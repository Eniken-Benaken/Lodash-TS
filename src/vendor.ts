...
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => chunk(array,3));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => compact(array));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => concat(array,12,"str",{obj: "object"}));
...
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => drop(array,4));
// if(secondaryButton !== null) secondaryButton.addEventListener("click", () => dropRight(array,4));
